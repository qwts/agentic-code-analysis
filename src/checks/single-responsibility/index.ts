// The single-responsibility check: orchestrates rule text, per-file
// comparisons, the verdict cache, and the judge (operational bounds per the
// check design: one file per request, concurrency 3, max_tokens 4096).
 ...
 * growth, and line counts are excluded: identity-independent or derived, so a
