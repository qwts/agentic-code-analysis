...
[ACA-0013](../decisions/ACA-0013-comparative-judgment.md). Fourth check of
the suite (failure-posture and test-honesty landed while this was in review); consumes the [suite design](suite.md) contracts (JudgeClient,
